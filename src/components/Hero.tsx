...
const Hero = () => {
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-chittoor-blue-light/20 via-white to-chittoor-green-light/20 py-16 md:py-20 lg:py-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-6 lg:gap-8 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="flex flex-col xs:flex-row gap-3 sm:gap-4 justify-center md:justify-start px-2 sm:px-0"
            >
              <a href="#about-projects" className="w-full sm:w-auto">
                <Button className="w-full bg-gradient-to-r from-chittoor-green via-chittoor-blue to-chittoor-green bg-200% hover:bg-right transition-all duration-1000 shadow-lg rounded-full px-4 py-3 sm:px-6 sm:py-4 md:px-8 md:py-6 text-sm sm:text-base md:text-lg font-medium hover:shadow-xl hover:scale-[1.02] transform transition-all">
                  Our Projects
                </Button>
              </a>
              <a href="#contact" className="w-full sm:w-auto">
                <Button
                  variant="outline"
                  className="w-full border-chittoor-blue text-chittoor-blue hover:bg-chittoor-blue/5 rounded-full px-4 py-3 sm:px-6 sm:py-4 md:px-8 md:py-6 text-sm sm:text-base md:text-lg font-medium"
                >
                  Contact Us
                </Button>
              </a>
