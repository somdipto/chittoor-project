...
const DonatePage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-chittoor-offwhite to-white">
      <Navbar />
              ...
              {!showQR ? (
                <>
                        ...
                        <Button
                          ...
                          className={`p-4 text-lg font-semibold ${
                            selectedAmount === amount
                              ? "bg-chittoor-green hover:bg-chittoor-green-dark"
                              : "border-2 border-gray-200 hover:border-chittoor-green"
                          }`}
                        >
                          ₹{amount}
                        </Button>
                  ...
                  <Button
                    ...
                    disabled={!upiId || (!selectedAmount && !customAmount)}
                    className="w-full p-6 text-lg font-semibold bg-gradient-to-r from-chittoor-green to-chittoor-green-dark hover:from-chittoor-green-dark hover:to-chittoor-green disabled:opacity-50"
                  >
                ...
                <div className="text-center space-y-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <Button
                      ...
                      className="flex-1 bg-chittoor-green hover:bg-chittoor-green-dark"
                    >
                      New Donation
                    </Button>
                  </div>
        ...
        >
          <div className="flex justify-center items-center gap-8 text-gray-600">
            <div className="flex items-center gap-2">
              <Users className="w-5 h-5 text-chittoor-green" />
              <span>1000+ Donors</span>
            </div>
            <div className="flex items-center gap-2">
              <Leaf className="w-5 h-5 text-chittoor-green" />
              <span>100% Transparent</span>
            </div>
            <div className="flex items-center gap-2">
              <Star className="w-5 h-5 text-chittoor-green" />
