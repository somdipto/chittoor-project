...
export const pillarsData: Pillar[] = [
  {
    ...
    status: "active",
    image:
      "https://images.unsplash.com/photo-1551984427-05d5dd9f0f16?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    description:
      "Food 'forest farms' with seven layers to renew soil, build water reservoirs naturally, and enhance biodiversity.",
    bg: "bg-gradient-to-br from-chittoor-green to-chittoor-green-dark",
    status: "active",
    image:
      "https://images.unsplash.com/photo-1602600203968-7a1c67c12fb4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    status: "planning",
    image:
      "https://images.unsplash.com/photo-1559700488-2268e5ba7e2b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    status: "planning",
    image:
      "https://images.unsplash.com/photo-1552071379-5999089b2c36?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    status: "active",
    image:
      "https://images.unsplash.com/photo-1623060693724-1e59e90a5d74?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div>
            <p className="mb-4">
              ...
              biodiversity. The project is modeled on a successful
